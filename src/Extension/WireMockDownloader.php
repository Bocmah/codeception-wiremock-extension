...
class WireMockDownloader
{
     ...
     */
    public function downloadAndGetLocalJarPath(string $version): string
    {
     ...
     */
    private function buildUrlForVersion(string $version): string
    {
     ...
     * @throws \Exception
     */
    private function downloadToPath(string $version, string $filePath): void
    {
